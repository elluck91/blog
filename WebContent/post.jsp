	...
	<div class="container">
		...
		<div class="row row-offcanvas row-offcanvas-right">
			<div class="col-lg-9 col-md-9 col-xs-9 col-sm-9">
				...
				<div class="jumbotron">
					<h2>
						<a href="#"><c:out value="<%=post.PostTitle%>" /></a>
					</h2>
					<img class="postimg" src="<c:out value="<%=post.PostImage%>"/>"/>
					<c:out value="<%=post.PostContent%>" />

					<br>
					<p>
						Article written by: <c:out
								value="<%=post.PostAuthor%>" />
					</p>
					<a href="./DeleteAPI?id=<%=post.ID%>"
						class="btn btn-danger" id="delete">Delete This Post!</a> <a
						href="./update.jsp?id=<%=post.ID%>" class="btn btn-success"
						id="update">Update This Post!</a>
				</div>
			</div>

...
charset=utf-8"
	pageEncoding="utf-8" isELIgnored="false" import="org.elluck91.first.*"%>
	...
	<div class="container">
		...
		<div class="row row-offcanvas row-offcanvas-right">
			<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
				...
				<br>
				<p>Bloggr ("us", "we", or "our") operates the
					ec2-34-209-69-148.us-west-2.compute.amazonaws.com website (the
					"Service").</p>
				<br>
				...
				<p>We will not use or share your information with anyone except
					as described in this Privacy Policy. Privacy Policy from TermsFeed
					for Bloggr.</p>
				<br>
				<p>We use your Personal Information for providing and improving
					...
					at ec2-34-209-69-148.us-west-2.compute.amazonaws.com</p>
				<br>
				...
				<p>While using our Service, we may ask you to provide us with
					...
					include, but is not limited to, your name, other information
					("Personal Information").</p>
				<br>
				<h2>Log Data</h2>
				<br>
				<p>We collect information that your browser sends whenever you
				...
				<br>
				<p>These third parties have access to your Personal Information
				...
				<p>We do not knowingly collect personally identifiable
					...
					Information, please contact us. If we discover that a Children
					under 13 has provided us with Personal Information, we will delete
					such information from our servers immediately.</p>
				<br>
				...
				<p>We may update our Privacy Policy from time to time. We will
					...
					page.</p>
				<br>
				<p>You are advised to review this Privacy Policy periodically
		...
		<footer>
			<div class="row">
				<div class="col-lg-12">
					<p>
						Copyright &copy; Lukasz Juraszek 2017 | <a href="privacy.jsp">Privacy
							Statement</a>
					</p>
				</div>
			</div>

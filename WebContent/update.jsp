...
<title>Update Post | Bloggr</title>
...
<body>
	...
	<div class="container">
		...
		<div class="container center-block">
			...
			<form class="form-signin" action="./UpdateAPI?id=<%= post.ID %>"
				...
				<input name="txtTitle" type="text" class="form-control"
					value="<%= post.PostTitle%>" required autofocus> <br>
				<p>
					<strong>Description: </strong>
				</p>
				<input name="txtDescription" type="text" class="form-control"
					value="<%= post.PostDescription %>" required> <br>
				<p>
					<strong>Image URL : </strong>
				</p>
				<input name="txtImage" type="text" class="form-control"
					value="<%= post.PostImage %>" required> <br>
				<p>
					<strong>Content : </strong>
				</p>
				<textarea name="txtContent" style="resize: both;" type="text"
					class="form-control" rows="15" cols="8" required><%= post.PostContent %> </textarea>
				<br>

				<input name="txtAuthor" type="hidden" value="<c:out value='<%=session.getAttribute("userid")%>' escapeXml="true" />">
                    <br>
				<button name="btnUpdate" class="btn btn-lg btn-primary btn-block"

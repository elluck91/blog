...
<%@page import="java.util.Iterator, java.net.URLDecoder"%>
	...
	<div class="container">
		...
		<div class="row row-offcanvas row-offcanvas-right">
			<div class="col-lg-9 col-md-9 col-xs-9 col-sm-9">
				...
				%>
				<h2>User: <%=session.getAttribute("userid") %></h2>
				<h2>Last Visit: <c:out value='<%=URLDecoder.decode(lastVisit.getValue(), "UTF-8")%>' escapeXml="true" /></h2>
